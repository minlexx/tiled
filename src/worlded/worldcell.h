...
/**
  ...
  */
class WORLDED_EXPORT WorldCellLot
{
public:
...
class WORLDED_EXPORT WorldCellLotList : public QList<WorldCellLot*>
{
public:
...
/**
  ...
  */
class WORLDED_EXPORT ObjectType
{
public:
    ObjectType();
...
/**
  ...
  * Each World has its own list of these.
  */
class WORLDED_EXPORT WorldObjectGroup
{
public:
...
/**
  ...
  * Each WorldCell has its own list of these.
  */
class WORLDED_EXPORT WorldCellObject : public PropertyHolder
{
public:
...
class WORLDED_EXPORT WorldCellObjectList : public QList<WorldCellObject*>
{
public:
...
class WORLDED_EXPORT WorldCellLevel
{
public:
...
/**
  ...
  */
class WORLDED_EXPORT WorldCell : public PropertyHolder
{
public:
...
/**
  ...
  */
class WORLDED_EXPORT WorldCellContents
{
public:
