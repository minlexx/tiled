...
class WORLDED_EXPORT ObjectGroupList : public QList<WorldObjectGroup*>
{
public:
...
class WORLDED_EXPORT ObjectTypeList : public QList<ObjectType*>
{
public:
    bool contains(const QString &name) const;
...
class WORLDED_EXPORT BMPToTMXSettings
{
public:
    QString exportDir;
    QString rulesFile;
...
class WORLDED_EXPORT GenerateLotsSettings
{
public:
    QString exportDir;
...
class WORLDED_EXPORT LuaSettings
{
public:
