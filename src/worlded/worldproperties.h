...
#include "worlded_global.h"

class World;

class WORLDED_EXPORT PropertyEnum
{
public:
...
class WORLDED_EXPORT PropertyEnumList : public QList<PropertyEnum*>
{
public:
...
class WORLDED_EXPORT PropertyDef
{
public:
...
class WORLDED_EXPORT PropertyDefList : public QList<PropertyDef*>
{
public:
...
class WORLDED_EXPORT PropertyList : public QList<Property*>
{
public:
...
class WORLDED_EXPORT PropertyTemplateList : public QList<PropertyTemplate*>
{
public:
...
class WORLDED_EXPORT PropertyHolder
{
public:
    PropertyHolder();
...
class WORLDED_EXPORT PropertyTemplate : public PropertyHolder
{
public:
    PropertyTemplate() {}
